...
REMOTE_SERVER_URL_api = "http://192.168.50.210:8000/data"
# REMOTE_SERVER_URL_api = "http://172.17.214.1:8000/data"
...
def getValue(name, value):
    ...
    while OPENED:
        ...
        guangzhao = tmp
        humidity = read(1)
        print_data = {"t":temperature, "h":humidity,"s":shidu,"g":guangzhao,"id":shebeiid}
        print (print_data)
        if temperature != None:
